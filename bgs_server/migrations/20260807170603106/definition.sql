...
--
-- Class Event as table bgs_event
--
CREATE TABLE "bgs_event" (
    ...
    "registrationOpensAt" timestamp without time zone,
    "registrationClosesAt" timestamp without time zone,
    "rulesUrl" text,
...
--
-- Class EventRegistration as table bgs_event_registration
--
...
--
-- Class League as table bgs_league
--
CREATE TABLE "bgs_league" (
    ...
    "status" text NOT NULL,
    "teamFeeCents" bigint NOT NULL,
    "seasonStartAt" timestamp without time zone,
    "seasonEndAt" timestamp without time zone,
    "registrationOpensAt" timestamp without time zone,
    "registrationClosesAt" timestamp without time zone,
    "rulesUrl" text,
    "createdAt" timestamp without time zone NOT NULL
...
--
-- Class MatchAttendance as table bgs_match_attendance
--
...
--
-- Class Organization as table bgs_organization
--
...
--
-- Class OrganizationMember as table bgs_organization_member
--
...
--
-- Class PlayerProfile as table bgs_player_profile
--
...
--
-- Class ScheduledMatch as table bgs_scheduled_match
--
...
--
-- Class Standing as table bgs_standing
--
...
--
-- Class TeamMembership as table bgs_team_membership
--
...
--
-- Foreign relations for "bgs_event" table
--
...
--
-- Foreign relations for "bgs_event_registration" table
--
...
--
-- Foreign relations for "bgs_league" table
--
...
--
-- Foreign relations for "bgs_match_attendance" table
--
...
--
-- Foreign relations for "bgs_organization_member" table
--
...
--
-- Foreign relations for "bgs_player_profile" table
--
...
--
-- Foreign relations for "bgs_scheduled_match" table
--
...
--
-- Foreign relations for "bgs_standing" table
--
...
--
-- Foreign relations for "bgs_team" table
--
...
--
-- Foreign relations for "bgs_team_membership" table
--
