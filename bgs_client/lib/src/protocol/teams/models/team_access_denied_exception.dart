...
/// Thrown when the caller has neither org-admin access nor an active
/// `manager` membership on the team in question.
abstract class TeamAccessDeniedException
    implements _i1.SerializableException, _i1.SerializableModel {
  TeamAccessDeniedException._({required this.teamId});

  factory TeamAccessDeniedException({required _i1.UuidValue teamId}) =
  ...
  @_i1.useResult
  TeamAccessDeniedException copyWith({_i1.UuidValue? teamId});
  @override
...
class _TeamAccessDeniedExceptionImpl extends TeamAccessDeniedException {
  _TeamAccessDeniedExceptionImpl({required _i1.UuidValue teamId})
