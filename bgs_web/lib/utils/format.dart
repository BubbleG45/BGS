...
/// (e.g. `Flag Football`). Duplicated from `bgs_flutter/lib/utils/format.dart`
/// -- Jaspr and Flutter are separate packages with no shared-code layer yet
/// (see BUILD_PLAN.md's note on the design-token package being future work).
